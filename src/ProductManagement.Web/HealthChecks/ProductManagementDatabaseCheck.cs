...
public class ProductManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ProductManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
